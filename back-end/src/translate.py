...
def main():
    ...
    parser.add_argument("--word2idx_path", type=str, default="./cache/anet_word2idx.json", help="")
    parser.add_argument("--v_duration_file", type=str, default="./video_feature/anet_duration_frame.csv", help="")
    ...
    checkpoint = torch.load(os.path.join(opt.res_dir, "model.chkpt"), map_location="cpu")
